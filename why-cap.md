---
description: Verifiable Money, Credible Financial Guarantees
---
...
stcUSD addresses these challenges by decentralizing the capital allocation process and providing verifiable recourse. An open network of Borrowers competes to deliver the best yield, with their strategies underwritten by Underwriters’ delegated capital. This model enables:

1. Verifiable Downside Protection: End users are covered from the risk of yield generation via Shared Security Networks. Borrowers must secure credit delegations via restaking to participate. All risk coverage is transparent and enforced by smart contracts, allowing users to verify protections onchain.&#x20;
